    ...
    public void onClick(View view) {
        ...
        if (id == R.id.qc_save) {
            ...
            if (liveInitValue > zero && liveInitValue <= HUNDERED) {
                faceThresholdDecimal = new BigDecimal(liveInitValue + "");
                liveInitValue = faceThresholdDecimal.subtract(levelValue).floatValue();
                thLiveEtThreshold.setText(liveInitValue + "");
            }
        } else if (id == R.id.th_LiveIncrease) {
            if (liveInitValue >= zero && liveInitValue < HUNDERED) {
                faceThresholdDecimal = new BigDecimal(liveInitValue + "");
                liveInitValue = faceThresholdDecimal.add(levelValue).floatValue();
                thLiveEtThreshold.setText(liveInitValue + "");
            }
        } else if (id == R.id.th_IDDecrease) {
            if (idInitValue > zero && idInitValue <= HUNDERED) {
                faceThresholdDecimal = new BigDecimal(idInitValue + "");
                idInitValue = faceThresholdDecimal.subtract(levelValue).floatValue();
                thIDEtThreshold.setText(idInitValue + "");
            }
        } else if (id == R.id.th_IDIncrease) {
            if (idInitValue >= zero && idInitValue < HUNDERED) {
                faceThresholdDecimal = new BigDecimal(idInitValue + "");
                idInitValue = faceThresholdDecimal.add(levelValue).floatValue();
                thIDEtThreshold.setText(idInitValue + "");
            }
